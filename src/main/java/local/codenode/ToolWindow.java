...
public final class ToolWindow extends JPanel {
    public enum DockPosition { LEFT, RIGHT, TOP, BOTTOM }
    public record DockRequest(DockPosition position,ToolWindow mergeWith) {}
    ...
    public void setCollapsed(boolean value){if(dialog!=null)return;collapsed=value;content.setVisible(!value);collapse.setText(value?"□":"—");revalidate();collapseListener.accept(value);}
