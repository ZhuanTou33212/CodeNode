...
final class UiTheme {
    ...
    static final Color PANEL = new Color(37, 37, 38);
    static final Color TOOLBAR = new Color(42, 45, 50);
    static final Color INPUT = new Color(51, 51, 55);
    static final Color BORDER = new Color(63, 63, 70);
    static final Color TEXT = new Color(220, 220, 220);
    static final Color MUTED = new Color(155, 164, 175);
    static final Color ACCENT = new Color(0, 122, 204);
    static final Color SELECTION = new Color(9, 71, 113);
    ...
    static Border panelBorder() { return new LineBorder(BORDER); }
    static Border sectionBorder() { return new CompoundBorder(new MatteBorder(0, 0, 1, 0, BORDER), new EmptyBorder(7, 10, 7, 10)); }
