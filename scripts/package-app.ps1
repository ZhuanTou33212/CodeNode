...
& $jpackage --type app-image --name CodeNodeDesktop --dest $dist --input (Join-Path $PSScriptRoot "..\target") --main-jar codenode-desktop.jar --main-class local.codenode.CodeNodeApp --app-version 0.1.5 --vendor CodeNode
