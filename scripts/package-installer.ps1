...
& $jpackage --type exe --name CodeNodeDesktop --dest $installer --input (Join-Path $projectRoot "target") --main-jar codenode-desktop.jar --main-class local.codenode.CodeNodeApp --app-version 0.5.0 --vendor CodeNode --file-associations (Join-Path $PSScriptRoot "cnode-associations.properties")
