...
[![Gates](https://img.shields.io/badge/gates-88%20core%20%2B%205%20display-brightgreen.svg)](scripts/run-all-tests.cjs)
...
| 门禁 | `npm run verify` = 构建 + `check:js`（主进程/脚本 checkJs）+ **88 项核心套件 + 5 项显示环境套件**；清单唯一来源 `scripts/run-all-tests.cjs` |
